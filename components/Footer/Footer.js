  ...
  return (
    <div className='footer_wrapper py-5'>
      <div className='container p-0'>
        <div className='row gx-4 footer-block-1'>
           ...
           <div className='col-12 col-lg-8'>
                <div className='row gx-2 d-flex flex-wrap'>
                    ...
                    <div className='col-6 col-md-5 mb-4 order-3 order-md-2'>
                        <div className='footer-main-text mb-4'>Contact Us</div>

                                    <div  className='footer-links footer-text'><span>
                    ...
                    <div className='col-12 col-md-3 mb-4 order-1 order-md-3'>
                            <div className='mb-3 footer-main-text'>
                ...
                <div className='row g-0 follow-us'>
